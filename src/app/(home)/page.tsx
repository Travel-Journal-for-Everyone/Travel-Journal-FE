...
export default function Home() {
  ...
  return (
    <div className="relative h-full">
      {/* 데스크탑: 검색 + 안내문 */}
      <div className="layout-wrapper flex flex-col md:flex-row gap-4 md:gap-24 justify-center md:justify-normal">
                    ...
                    <div className="hidden md:flex flex-wrap gap-1 items-center mt-1.5">
                      <div className="flex flex-wrap">
                        <div className="relative w-4 h-4">
                          <Image src="/icons/Icon-paper-gray-18px.svg" alt="Diary" fill />
                        </div>
                        <span className="text-gray7">
                          {regionData.travelDiaryCount > 99 ? "99+" : regionData.travelDiaryCount}
                          일지
                        </span>
                      </div>
                      <div className="flex flex-wrap">
                        <div className="relative w-4 h-4">
                          <Image src="/icons/Icon-pin-gray-18px.svg" alt="place" fill />
                        </div>
                        <span className="text-gray7">
                          {regionData.placesCount > 99 ? "99+" : regionData.placesCount}곳
                        </span>
                      </div>
                    </div>
                  )}
